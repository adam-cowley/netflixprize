...
class ImportThread:
    def __init__(self, driver, batch_number, batch):
        self.driver = driver
    ...
    def run(self):
        ...
        try:
            session.run(query, batch=self.batch)

            print("Finished batch", self.batch_number)
        except:
            print("Retrying batch", self.batch_number)
            self.run()
...
class Importer:
    ...
    def execute_batch(self):
        ...
        task = ImportThread(self.driver, self.batches, self.batch)
